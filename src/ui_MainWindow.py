...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.openOrdersListView = QtWidgets.QListView(self.openOrdersTab)
        self.openOrdersListView.setObjectName("openOrdersListView")
        self.gridLayout_9.addWidget(self.openOrdersListView, 0, 0, 1, 1)
        ...
        self.conditionalListView = QtWidgets.QListView(self.conditionalTab)
        self.conditionalListView.setObjectName("conditionalListView")
        self.gridLayout_10.addWidget(self.conditionalListView, 0, 0, 1, 1)
        ...
        self.menu_Load = QtWidgets.QMenu(self.fileMenu)
        self.menu_Load.setObjectName("menu_Load")
        self.menu_Save = QtWidgets.QMenu(self.fileMenu)
        ...
        self.loadSettingsAction = QtWidgets.QAction(MainWindow)
        self.loadSettingsAction.setObjectName("loadSettingsAction")
        self.loadAccountsAction = QtWidgets.QAction(MainWindow)
        self.loadAccountsAction.setObjectName("loadAccountsAction")
        self.saveSettingsAction = QtWidgets.QAction(MainWindow)
        self.saveSettingsAction.setObjectName("saveSettingsAction")
        self.saveAccountsAction = QtWidgets.QAction(MainWindow)
        self.saveAccountsAction.setObjectName("saveAccountsAction")
        self.menu_Load.addAction(self.loadSettingsAction)
        self.menu_Load.addAction(self.loadAccountsAction)
        self.menu_Save.addAction(self.saveSettingsAction)
        self.menu_Save.addAction(self.saveAccountsAction)
        self.fileMenu.addAction(self.setupAction)
        self.fileMenu.addSeparator()
        self.fileMenu.addAction(self.menu_Load.menuAction())
        self.fileMenu.addAction(self.menu_Save.menuAction())
        self.fileMenu.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menu_Load.setTitle(_translate("MainWindow", "&Load"))
        ...
        self.loadSettingsAction.setText(_translate("MainWindow", "Settings"))
        self.loadAccountsAction.setText(_translate("MainWindow", "Accounts"))
        self.saveSettingsAction.setText(_translate("MainWindow", "Settings"))
        self.saveAccountsAction.setText(_translate("MainWindow", "Accounts"))
