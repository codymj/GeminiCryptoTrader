...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btcGraph = QtWidgets.QWidget(self.btcTab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btcGraph.sizePolicy().hasHeightForWidth())
        self.btcGraph.setSizePolicy(sizePolicy)
        self.btcGraph.setObjectName("btcGraph")
        self.gridLayout_4.addWidget(self.btcGraph, 1, 0, 1, 1)
        ...
        self.ethGraph = QtWidgets.QWidget(self.ethTab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ethGraph.sizePolicy().hasHeightForWidth())
        self.ethGraph.setSizePolicy(sizePolicy)
        self.ethGraph.setObjectName("ethGraph")
        self.gridLayout_6.addWidget(self.ethGraph, 1, 0, 1, 1)
